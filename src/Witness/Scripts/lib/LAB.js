// Modified LAB.js to expose a function `installLAB`
// This is used to inject LABjs into an iframe window.
// The created $LAB is also returned by the function so the parent window
// can keep a reference and use it to add scripts to the iframe later.
...
window.installLAB = function (global) {
